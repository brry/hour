...
\normalsize
\vspace{12em}
Berry Boessenkool, June 2018 - Sept 2026\\[0.5em]
...
\item R installation instructions: \href{https://brry.github.io/course/install.html}{brry.github.io/course/install}\\
\hrulefill
...
\begin{enumerate}%[<+->]
  ...
  \item BONUS: Change RStudio settings, see \href{https://brry.github.io/course/settings.html}{brry.github.io/course - settings}
\end{enumerate}
\end{exercise}
\end{frame}
...
plot(clim$TMK, clim$VPM, xlab="air temperature", ylab="vapor pressure", 
     ...
     (correlation daily averages Potsdam 2025-2026, DWD)",
...
@
  ...
  \item Use the output from task 3 to give the plot a title.
...
\item \href{https://brry.github.io/course/}{brry.github.io/course}
